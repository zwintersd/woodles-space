...
//
// `reach` / `permanence` / `uncertain` record the cost↔reach character each
// verb carries — cheap interventions are broad and low-magnitude, dear ones
...
import type { Intervention, LifeDomain } from '../types.js';
